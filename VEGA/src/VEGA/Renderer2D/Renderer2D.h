...
namespace VEGA {
	...
	public:
		...
		static void DrawQuad(const glm::vec3& position, const glm::vec2& size, const Ref<Texture2D>& texture,f32 tiling_factor = 1.0f,const glm::vec4& tintColor = glm::vec4(1.0f));
		...
		static void DrawRotatedQuad(const glm::vec3& position, const glm::vec2& size, f32 rotation, Ref<SubTexture2D>& Subtexture,f32 tiling_factor = 1.0f,const glm::vec4& tintColor = glm::vec4(1.0f));
		static void DrawRotatedQuad(const glm::vec2& position, const glm::vec2& size, f32 rotation, Ref<SubTexture2D>& Subtexture,f32 tiling_factor = 1.0f,const glm::vec4& tintColor = glm::vec4(1.0f));
